...
{
    /// <summary>
    /// Autorizza ruolo Admin e ConsulenteCs
    /// </summary>
    public class AuthorizeAziendaConsulenteCs : AuthorizeAttribute
    {
        protected override bool AuthorizeCore(HttpContextBase httpContext)
        {
            ...
            if (httpContext.User.IsInRole(IdentityHelper.Roles.Admin.ToString()) 
                || httpContext.User.IsInRole(IdentityHelper.Roles.Azienda.ToString()) 
                || httpContext.User.IsInRole(IdentityHelper.Roles.ConsulenteCs.ToString()))
            {
                return true;
            }
